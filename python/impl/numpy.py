import numpy as np
from ..contract import impl, Tensor
from ..traits import Backend, Locality, DType, Algorithm


ε = np.newaxis


@impl(Algorithm.RS, Backend.NUMPY, Locality.CPU, description = 'array programming implementation')
...
@impl(Algorithm.RS, Backend.NUMPY, Locality.CPU, description = 'simulate complex numbers with real numbers')
