...
int main(int argc, char* argv[]) {
	...
	// gs_kernel_pupil(q, static_cast<int>(spots.size()), device_spots, device_pists, device_phase, pupil_count, device_pupil, parameters, 30);
	gs_kernel_reduction(q, static_cast<int>(spots.size()), device_spots, device_pists, device_spot_fields, device_phase, pupil_count, device_pupil, parameters, 30);
	// gs_kernel_block(q, static_cast<int>(spots.size()), device_spots, device_pists, device_spot_fields, device_phase, pupil_count, device_pupil, parameters, 30);
